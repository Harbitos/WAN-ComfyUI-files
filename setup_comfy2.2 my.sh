...
# --- 5. Загрузка моделей ---
echo "Загрузка моделей и настроек для Wan 2.2..."
...
sleep 10
download_with_retries "https://huggingface.co/Wan-AI/Wan2.2-T2V-A14B/resolve/main/Wan2.1_VAE.pth?download=true" "${MODELS_PATH}/vae/Wan2.1_VAE.pth"
sleep 10
...
sleep 10
download_with_retries "https://huggingface.co/bullerwins/Wan2.2-I2V-A14B-GGUF/resolve/main/wan2.2_i2v_high_noise_14B_Q5_K_S.gguf?download=true" "${MODELS_PATH}/unet/wan2.2_i2v_high_noise_14B_Q5_K_S.gguf"
sleep 10
download_with_retries "https://huggingface.co/bullerwins/Wan2.2-I2V-A14B-GGUF/resolve/main/wan2.2_i2v_low_noise_14B_Q5_K_S.gguf?download=true" "${MODELS_PATH}/unet/wan2.2_i2v_low_noise_14B_Q5_K_S.gguf"
sleep 10
download_with_retries "https://huggingface.co/lightx2v/Wan2.2-Lightning/resolve/main/Wan2.2-I2V-A14B-4steps-lora-rank64-Seko-V1/high_noise_model.safetensors?download=true" "${MODELS_PATH}/loras/wan2.2_high_noise_lora.safetensors"
sleep 10
download_with_retries "https://huggingface.co/lightx2v/Wan2.2-Lightning/resolve/main/Wan2.2-I2V-A14B-4steps-lora-rank64-Seko-V1/low_noise_model.safetensors?download=true" "${MODELS_PATH}/loras/wan2.2_low_noise_lora.safetensors"

CIVITAI_URL="https://civitai.com/api/download/models/2067386?type=Model&format=SafeTensor"
LORA_PATH="${MODELS_PATH}/loras/l1v3w4llp4p3r.safetensors"
